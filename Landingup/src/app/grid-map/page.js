...
export default function Rent() {
  return (
    <>
      ...
      <section style={{ backgroundImage: "url('/images/bg/b17.jpg')" }}
      ...
      <section className="relative md:pb-24 pb-16 bg-gray-100 dark:bg-gray-800">
        <div className="container lg:mt-24 mt-16 flex flex-col items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-lg p-6 flex flex-col items-center justify-center">
              <p className="text-center">Just click on rent now..</p>
            </div>
            <div className="bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-lg p-6 flex flex-col items-center justify-center">
              <p className="text-center">Enter your desired date and number of hours..</p>
            </div>
            <div className="bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-lg p-6 flex flex-col items-center justify-center">
              <p className="text-center">Select your favorite vehicle and enjoy your ride..</p>
            </div>
          </div>
        </div>
        <div className="container lg:mt-24 mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-lg p-6 flex flex-col items-center justify-center">
              <p className="text-center">Keep a car and drive up to 24hrs...</p>
            </div>
            <div className="bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-lg p-6 flex flex-col items-center justify-center">
              <p className="text-center">Ideal for meetings, tourist travels and short trips..</p>
            </div>
            <div className="bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-lg p-6 flex flex-col items-center justify-center">
              <p className="text-center">Book for now reserve for later..</p>
            </div>
          </div>
