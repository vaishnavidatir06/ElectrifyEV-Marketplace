      ...
      <div className="container mx-auto pt-20 pb-12 grid grid-cols-2 gap-8">
        <div className="col-span-1">
          <div className="md:text-start text-center">
            <p className="text-6xl font-semibold mb-8 text-slate-50 pt-20">Most trusted solution for roadside emergency</p>
          </div>
        </div>
        <div className="col-span-1">
          <div className="max-w-md mx-auto bg-gray-200 rounded-lg shadow-lg pt-10 px-8 pb-8">
            <p className="text-xl font-semibold mb-8 text-black-600 ">For emergency</p>
