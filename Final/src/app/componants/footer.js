                            ...
                            <div className="relative w-full">
                                ...
                                <div className="grid md:grid-cols-12 grid-cols-1 gap-[30px] -mt-24">
                                    <div className="lg:col-span-4 md:col-span-12">
                                        ...
                                        <p className="mt-6 text-gray-300">Drive eV. Drive Evolution. Drive the Change.</p>
                                    ...
                                    <div className="lg:col-span-3 md:col-span-4">
                                        ...
                                        <div className="flex mt-6">
                                            ...
                                            <div className="">
                                                <h6 className="text-gray-300 mb-2">Suratwala mark Plazzo 5th floor,Office no. 517, Hinjewadi phase 1,  <br /> Pune-411057, <br /> Maharastra, India.</h6>
                                        ...
                                        <div className="flex mt-6">
                                            ...
                                            <div className="">
                                                <Link href="mailto:info@trailique.com" className="text-slate-300 hover:text-slate-400 duration-500 ease-in-out">info@trailique.com</Link>
                                            </div>
                                        </div>
