                        ...
                        return (
                            <div className="lg:col-span-12 md:col-span-13" key={index}>
                                <div className="group text-center">
                                    <div className="relative inline-block mx-auto h-52 w-52 rectangle-full overflow-hidden flex justify-center items-center"> {/* Center alignment */}
                                        <Image src={item.images} className="" alt="" width={208} height={208} priority />
                                        <div className="absolute inset-0 bg-gradient-to-b from-transparent to-black h-52 w-52 rectangle-full opacity-0 group-hover:opacity-100 transition-all duration-500 ease-in-out"></div>
