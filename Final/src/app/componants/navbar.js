            ...
            <nav id="topnav" className={`${topNavbar ? 'nav-sticky' : ''} ${topnavClass ? topnavClass : ''} defaultscroll is-sticky`} >
                <div className={`${topnavClass !== '' && topnavClass !== undefined ? 'container-fluid md:px-8 px-3' : 'container'}`}>
                    ...
                    <div id="navigation" className={`${isOpen === true ? 'hidden' : 'block'}`} >
                        ...
                        < li className={["/buy", "/Car", "/cycle", "/scooter", "/auto", "/drone", "/tractor"].includes(manu) ? 'active' : ''} style={{ fontFamily: 'YourCustomFont, Display' }}>
    < Link href="/buy" className="sub-menu-item">Buy</Link>
</li>
< li className={["/sell", "/sell-form"].includes(manu) ? 'active' : '' } style={{ fontFamily: 'YourCustomFont, Display' }}>
    <Link href="/sell" className="sub-menu-item">Sell</Link>
</li>
                            < li className={`has-submenu parent-parent-menu-item ${["/grid", "/grid-sidebar", "/rent", "/list", "/list-sidebar", "/list-map", "/services", "/batteryswap", "/BatteryCharge", "/carwash"].includes(manu) ? 'active' : ''}`}>
                                <Link href="#" onClick={() => { setSubManu(subManu === "/list-item" ? "" : "/list-item "? 'active' : '') }} style={{ fontFamily: 'YourCustomFont, Display' }}>Services</Link><span className="menu-arrow"></span>
                                < ul className={`submenu ${["/grid", "/grid-sidebar", "/rent", "/list", "/services", "/batteryswap", "/BatteryCharge", "/carwash", "/grid-item", "/list-view-item", "/property-item"].includes(subManu) ? 'open' : ''}`}>
                                    <li className="has-submenu parent-menu-item" style={{ fontFamily: 'YourCustomFont, Display' }}><Link href="rent"> Rentals </Link></li>
