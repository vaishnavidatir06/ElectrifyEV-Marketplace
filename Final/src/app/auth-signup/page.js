...
export default function Signup() {
    ...
    const handleSignup = async (e) => {
        ...
        if (!emailPattern.test(userData.email)) {
            toast.error('Please enter a valid email address.'); // Display error message if email format is incorrect
            return;
        }
        ...
        if (!acceptTermsCheckbox.checked) {
            toast.error('Please accept the Terms and Conditions.'); // Display error message if Terms and Conditions checkbox is not checked
            return;
        }
