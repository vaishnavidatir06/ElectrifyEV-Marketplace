                ...
                <div className="container">
                    <div className="md:flex justify-center">
                        ...
                        <div className="p-6 bg-white dark:bg-slate-900 shadow dark:shadow-gray-700 rounded-md">
                                ...
                                <p className="text-slate-900">There is now an abundance of readable dummy texts. These are usually used when a text is required purely to fill a space. These alternatives to the classic Lorem Ipsum texts are often amusing and tell short, funny or nonsensical stories.</p>

                                <h5 className="text-xl font-medium mb-4 mt-8">We use your information to :</h5>
                                <ul className="list-unstyled text-slate-900 mt-4">
