...
import { FiChevronLeft, FiChevronRight, MdDirectionsCar, MdSettingsInputComponent, MdTune, MdBatteryFull,FaBicycle} from '../assets/icons/vander';
...
const applyFilters = () => {
    ...
    const handleAddToWishlist = async (ecycle) => {
        try {
            ...
            const wishlistResponse = await fetch('http://51.79.225.217:5000/wishlist', {
                ...
                body: JSON.stringify({ userId, ...ecycle, vehicleId: ecycle._id }), // Assuming vehicle contains a _id property
            });
    ...
    return (
        ...
        <Link href={`/vehicle-detail?id=${ecycle._id}`} key={ecycle._id}>
                                            ...
                                            <div className="p-6 group-hover:bg-black-100 dark:group-hover:bg-black-100">
                                                ...
                                                <ul className="py-6 border-y border-slate-100 dark:border-gray-800 flex items-center list-none">
                                                    <li className="flex items-center me-4">
                                                        <FaBicycle width={30} className="me-2 text-green-600" />
                                                    ...
                                                    <li className="flex items-center me-4">
                                                        ...
                                                        <span>{ecycle.batteryPower}Ah</span>
                                                    </li>
                                                </ul>
                                            ...
                                            <div className="absolute top-4 end-4">
                                                <button onClick={() => handleAddToWishlist(ecycle)} className="flex-none flex items-center justify-center w-9 h-9 rounded-md bg-white border dark:bg-black border text-gray-200 dark:text-black-200 hover:text-red-500 dark:hover:text-red-500" type="button" aria-label="Like">
                                                    <svg width="20" height="20" fill="currentColor" aria-hidden="true">
