    ...
    <div className="bg-gray-100 min-h-screen" style={{ backgroundImage: `url('/images/bg/bs4.jpeg')`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed' }}>
      ...
      <section className="container mx-auto px-4 py-8 bg-white shadow-md rounded-md mt-20">
        <div className="flex items-center justify-center mb-8">
          ...
          <div className="rounded-md shadow bg-white dark:bg-slate-900 shadow-md">
            <h2 className="text-3xl font-bold mb-4 text-center text-gray-950 dark:text-gray-950 pt-10">Battery Recharge Service</h2>
            <p className="text-gray-800 mb-6 leading-relaxed px-10">Our technicians will come to your location, uninstall the battery, take it to our store, and charge it using our advanced charging machines. After charging, we'll observe the battery to ensure it holds the voltage. If everything is fine, we'll reinstall it in your vehicle.</p>
            <ul className="list-disc pl-6 mb-8 px-10">
              <li className="text-gray-800 mb-2 px-10">Trained Professionals</li>
              <li className="text-gray-800 mb-2 px-10">100% Customer Satisfaction</li>
              <li className="text-gray-800 mb-2 px-10">Fastest & Professional Service</li>
            </ul>
            <h3 className="text-lg font-bold mb-2 text-gray-950 dark:text-gray-950 px-5">Service Prices</h3>
            <ul className="list-disc pl-6 mb-6 px-10">
              <li className="text-gray-800 mb-2 px-10">At Doorstep (Within City limits): $40</li>
              <li className="text-gray-800 mb-2 px-10">At Service Station: $25</li>
            </ul>
          </div>
        </div>
      </section>
