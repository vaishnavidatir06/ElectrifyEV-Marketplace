        ...
        <>
            <div className="container lg:mt-24 mt-16">
                <div className="grid grid-cols-1 pb-8 text-center">
                    ...
                    <p className="text-slate-400 max-w-xl mx-auto">A great platform to buy, sell and rent e-Vehicle.</p>
                </div>
                    ...
                    {properties.map((item, index) => (
                        ...
                        <div className="group relative rounded-xl text-black dark:text-white overflow-hidden transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-xl">
                            ...
                            <Image src={item.image}alt=""width={0}  height={0} sizes="100vw" style={{ width: '400px', height: '200px', objectFit: 'cover' }}priority/>
                              ...
                              <button class="flex-none flex items-center justify-center w-9 h-9 rounded-md bg-black border dark:bg-white border text-white-200 dark:text-white-200 hover:text-red-500 dark:hover:text-red-500" type="button" aria-label="Like">
