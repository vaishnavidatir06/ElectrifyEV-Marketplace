...
import { FiChevronLeft, FiChevronRight, MdBatteryFull, MdFlight, MdSettingsInputComponent } from '../assets/icons/vander';
    ...
    {/* </div> */}
            ...
            <section className="relative lg:py-24 py-16">
                ...
                {drone.frontImagesBase64 && drone.frontImagesBase64.length > 0 && (
                    <Image src={`data:image/jpeg;base64,${drone.frontImagesBase64[0]}`} alt="Front View" className="h-40 w-auto" />
                )}
                </div>
