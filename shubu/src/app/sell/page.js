                ...
                <div className="container lg:mt-24 mt-16" style={{ marginTop: '-16px' }}>
                    <div className="grid grid-cols-1 pt-5 text-center">
                        ...
                        <li className="sm:inline ps-1 mb-0 hidden">
                            <Link href="/sell-form" className="btn  bg-green-600 hover:bg-green-700 border-green-600 dark:border-green-600 text-white rounded-full py-3 px-10 transition duration-300 ease-in-out">Sell</Link>
                        </li>
</div>
