...
export default function AutoDetail(props) {
  ...
  const goToPrevious = () => {
    switch (currentImageType) {
      case 'interior':
        setPhotoIndex((photoIndex + Auto.interiorImages.length - 1) % Auto.interiorImages.length);
        break;
      case 'front':
        setPhotoIndex((photoIndex + Auto.frontImages.length - 1) % Auto.frontImages.length);
        break;
      case 'side':
  ...
  const goToNext = () => {
    switch (currentImageType) {
      case 'interior':
        setPhotoIndex((photoIndex + 1) % Auto.interiorImages.length);
        break;
      case 'front':
        setPhotoIndex((photoIndex + 1) % Auto.frontImages.length);
        break;
      case 'side':
